...
public class BoletoLinhaDigitavelDV extends AbstractDigitoVerificador {
	...
	public int calcule(String numero) throws IllegalArgumentException {
		...
		if (StringUtils.isNotBlank(numero) && matches(REGEX_CAMPO, numero)) {
			...
			Exceptions.throwIllegalArgumentException("O campo [" + numero + "] da linha digitável deve conter apenas números com 9 ou 10 dígitos " + "ou nos formatos [#####.####, #####.#####]");
		}
