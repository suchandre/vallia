...
public abstract class AbstractCPRFValidator {
	 ...
	 * @since 0.2
	 */
	public static final AbstractCPRFValidator create(String codigoDoCadastro) throws IllegalArgumentException {
	...
	public static final AbstractCPRFValidator create(TipoDeCPRF tipoDeCadastro) {
		...
		if (isNotNull(tipoDeCadastro)) {
			...
			Exceptions.throwIllegalArgumentException("Tipo de Cadastro [ \"" + tipoDeCadastro + "\" ] nulo !");
		}
	...
	private static TipoDeCPRF selectTipoDeCadastro(String codigoDoCadastro) throws IllegalArgumentException {
		...
		switch_Tipo: {
			...
			Exceptions.throwIllegalArgumentException("O código de cadastro [ \"" + codigoDoCadastro + "\" ] não está em um formato válido !");
		}
	 ...
	 * @since 0.2
	 */
	public static final boolean isParametrosValidos(String codigoDoCadastro, TipoDeCPRF tipoDeCadastro) throws IllegalArgumentException {
		...
		if (isNotNull(codigoDoCadastro) && isNotNull(tipoDeCadastro)) {
			...
			if (Pattern.matches(REGEX_CADASTRO, codigoDoCadastro)) {
				...
				Exceptions.throwIllegalArgumentException("O cadastro está em um tamanho incorreto ou não exsite: [ \"" + codigoDoCadastro + "\" ]");
			}
		} else {

			Exceptions.throwIllegalArgumentException("O tipo de cadastro está incorreto: [ \"" + tipoDeCadastro + "\" ] ou o cadastro não exsite: [ \"" + codigoDoCadastro + "\" ]");
		}
